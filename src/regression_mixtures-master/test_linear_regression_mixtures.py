...
import numpy as np
from mlr import linear_regression_mixtures
...
if __name__ == '__main__':
    ...
    results = linear_regression_mixtures.fit_with_restarts(DATA, KEYS, 3, 20, 8, stochastic=False, verbose=True, num_workers=4)
    results = linear_regression_mixtures.fit_mixture(DATA, KEYS, 3, 20, stochastic=False, verbose=True)
    ...
    NUM_FOLDS = 10
    NUM_WORKERS = 3
    results = linear_regression_mixtures.cross_validate(DATA, KEYS, 5, 1, 10, 20, stochastic=False, verbose=True)
