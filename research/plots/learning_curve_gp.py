...
with open("data/accuracy_outlier_2_granularity_0.001.pkl", 'rb') as f:
    a2 = cp.load(f)
with open("data/gp_accuracy_outlier_10000_normalized_false.pkl", 'rb') as f:
    a3 = cp.load(f)
...
plt.errorbar(x, a3_median, a3_std, label="GP")
...
plt.savefig("fig/gp_accuracy_final.pdf")
plt.close()
...
with open("data/rmse_outlier_2_granularity_0.001.pkl", 'rb') as f:
    r2 = cp.load(f)
with open("data/gp_rmse_outlier_10000_normalized_false.pkl", 'rb') as f:
    r3 = cp.load(f)
...
plt.errorbar(x, r3_median, r3_std, label="GP")
...
plt.savefig("fig/gp_rmse_final.pdf")
plt.close()