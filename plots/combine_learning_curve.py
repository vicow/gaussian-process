...
plt.errorbar(x, a4_median, a4_std)
plt.xlabel("Relative time")
plt.ylabel("Accuracy")
plt.title("Learning curve for mixture of linear regressions with one feature")
plt.grid()
plt.legend(["Vincent", "Outliers > 2", "Outliers > 10", "Outliers > 20"], loc=4)
...
plt.errorbar(x, r4_median, r4_std)
plt.xlabel("Relative time")
plt.ylabel("RMSE")
plt.title("Learning curve for mixture of 2 linear regressions with one feature")
plt.grid()
plt.legend(["Outliers > 2", "Outliers > 10", "Outliers > 20"], loc=1)
